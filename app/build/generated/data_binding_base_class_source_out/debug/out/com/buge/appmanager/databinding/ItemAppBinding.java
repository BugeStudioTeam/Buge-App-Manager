...
public final class ItemAppBinding implements ViewBinding {
  ...
  private ItemAppBinding(@NonNull MaterialCardView rootView, @NonNull ImageView appIcon,
      @NonNull TextView appName, @NonNull TextView appVersion, @NonNull TextView packageName,
  ...
  public static ItemAppBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAppBinding((MaterialCardView) rootView, appIcon, appName, appVersion,
          packageName, systemAppBadge);
    }
